  ...
  return(
      <div className="Home">      
       ...
       <div className="ContentBox">
              ...
              <tbody>
         <Forum icon="i" name="Viti Par" desc="Look here for announcements regarding UBT."threads="22" posts="22" lastPost="This post"/>
         <Forum icon="i" name="Viti Dyt" desc="Leave feedback or post suggestions to improve the sites quality."threads="22" posts="22" lastPost="This post"/>
         <Forum icon="i" name="Viti Tret" desc="If you need help with anything site-related, this is the right place to ask for help."threads="22" posts="22" lastPost="This post"/>
...
export function CSE(){
  return(
      <div className="Home">      
        <div className="Subject" >
       <div className="ContentBox">
              <div className="ContentBoxHeader"> <h3>CSE</h3></div>
              <div className="ContentBoxBody"> 
              <table>
               <thead>
                  <tr>
