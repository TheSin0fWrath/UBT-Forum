...
export default function UserReputation(){
    ...
    //     let response = await fetch("http://localhost:5000/getuser/"+logedUserid);
    //     response = await response.json();
    //     setGetRepList(response);
    //     console.log(response,'rep list');
    //     setBusy(false);
    // }
    React.useEffect(async () => {
        ...
        fetchMyUser();
        // async function getRepListApi() {
        //     let response = await fetch("http://localhost:5000/api/reputation/"+ user.nameid);
        //     response = await response.json();
        //     setGetRepList(response);
        //     console.log(response,'rep list');
        //     setBusy(false);
